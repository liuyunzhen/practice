...
public class PicUploadController {
	...
	@Autowired
	private PropertiesService propertiseService;
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, propertiseService.REPOSITORY_PATH), "\\", "/");
		fileUploadResult.setUrl(propertiseService.IMAGE_BASE_URL + picUrl);
	...
	private String getFilePath(String sourceFileName) {
		String baseFolder = "D:\\go" + File.separator + "images";
