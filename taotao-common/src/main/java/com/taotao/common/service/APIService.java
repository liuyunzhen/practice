...
public class APIService implements BeanFactoryAware {
	...
	public ResultObjectStrData doPost(String url, Map<String, String> params) throws ClientProtocolException, IOException{
	...
	public ResultObjectStrData doPost(String url) throws ClientProtocolException, IOException{
